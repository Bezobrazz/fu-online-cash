...
export const ProductCard: React.FC<ProductCardProps> = ({ productName, productQuantity, productPrice, productInitials }) => {
  return (
    <div className='w-70 p-2 pb-10 border-b-2 cursor-pointer'>
        ...
        <p className='text-base font-thin text-slate-500'>Залишок: {productQuantity}</p>
